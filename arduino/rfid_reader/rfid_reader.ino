 ...
 * 
 * Protocol:
 * - Listens for "TIME:<YYYY-MM-DD HH:MM:SS>" and "STATUS:<ENTRY|EXIT>"
 * - Sends "<UID>,<YYYY-MM-DD HH:MM:SS>,<STATUS>" over serial when card is tapped
 * 
 ...
 * - MFRC522 MISO      -> Pin 12
 * - MFRC522 RST       -> Pin 9
 * - LED Ready (Blue)  -> Pin 7
 * - LED Success (Grn) -> Pin 6
 * - LED Error (Red)   -> Pin 5
 */
#include <SPI.h>
#include <MFRC522.h>
